...
Don Dellilo is the most underrated novelist of the 20th century. I don't care if he's received the National Book Award, or the PEN/Faulkner medal, or other honorifics from the academy. His name only broached discussion once in my four years as an English major at UVA (thank you, Rita Felski!). You need a magnifying glass to find his name mentioned on the Postmodern literature [Wikipedia entry](https://en.wikipedia.org/wiki/Postmodern_literature). In terms of secondary criticism, we can run a quick search on JSTOR. Pynchon outstrips DeLillo 2 to 1; Nabokov bests him 3 to 1; criticism about David Foster Wallace, ruler of them all, dwarfs DeLillo at a rate of 10 to 1. There are 19 results on Etsy when you search for DeLillo; run a similar search for Kurt Vonnegut and 812 results (with Ads!) your screen.

DeLillo suffers from a major issue with what in the web development industry call "Search Engine Optimization" (SEO). In brief, SEO is how you get your brand or company's name stuck at the top of Google. 
